...
def run_workflow():
    ...
    def when_successful(job_runner):
        url_location(request.url_root)(job_runner)
        update_job(job_runner)
    ...
    # the db transaction needs to happen before we can use the id,
    # as the id is generated by the db
